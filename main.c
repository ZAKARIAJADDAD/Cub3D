...
/*   Updated: 2023/08/18 12:25:22 by zael-wad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_line(t_var *data, int x_pos)
{
	...
	// Projected_Slice_Height = 50 * data->distance_to_projection_plane / (data->player_pos.angle_in_radian * cos(data->player_pos.ray_angle));
